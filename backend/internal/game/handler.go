...
func (h *Handler) Routes() chi.Router {
	...
	r.Delete("/{gameID}/characters/{characterID}", h.DeleteCharacter)
	...
	r.Post("/{gameID}/characters/{characterID}/inventory/{inventoryItemID}/split", h.SplitInventoryItem)
	...
	r.Get("/{gameID}/trades", h.ListTrades)
	r.Post("/{gameID}/trades", h.CreateTrade)
	r.Post("/{gameID}/trades/{tradeID}/accept", h.AcceptTrade)
	r.Post("/{gameID}/trades/{tradeID}/decline", h.DeclineTrade)
	r.Get("/{gameID}/activity", h.GetActivity)
	r.Delete("/{gameID}/activity", h.ClearActivity)
	r.Get("/{gameID}/chat-messages", h.GetChatMessages)
	r.Delete("/{gameID}/chat-messages", h.ClearChatMessages)
