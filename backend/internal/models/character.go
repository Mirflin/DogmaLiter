...
type Character struct {
	...
	// Health and Armor Class are optional, per-game combat stats. MaxHealth and
	// ArmorClass are GM-set base values that items can modify; CurrentHealth is
	// player-editable.
	MaxHealth     int `gorm:"default:10" json:"max_health"`
	CurrentHealth int `gorm:"default:10" json:"current_health"`
